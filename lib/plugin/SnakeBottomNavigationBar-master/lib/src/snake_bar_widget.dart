...
class _SnakeNavigationBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    ValueNotifier<double> _height = ValueNotifier<double>(0.0);
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (_height.value == 0.0) {
        final renderBox =
            _tilesKey.currentContext?.findRenderObject() as RenderBox?;
        _height.value = renderBox?.size.height ?? 0.0;
      }
    });
    ...
    return AnimatedPadding(
      ...
      child: Stack(
        ...
        children: [
          SafeArea(
            ...
            child: Material(
                ...
                child: AnimatedContainer(
                  ...
                  width: width,
                  child: Stack(
                    alignment: theme.snakeShape.type == SnakeShapeType.circle
                        ? Alignment.center
          ...
          AnimatedContainer(
            width: isPinned ? MediaQuery.of(context).padding.right : 0,
            decoration: BoxDecoration(gradient: theme.backgroundGradient),
            duration: kThemeChangeDuration,
          ),
        ],
