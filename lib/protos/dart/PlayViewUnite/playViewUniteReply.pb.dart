...
class PlayViewUniteReply extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PlayViewUniteReply', createEmptyInstance: create)
    ...
    ..aOM<FragmentVideo>(10, _omitFieldNames ? '' : 'fragmentVideo', subBuilder: FragmentVideo.create)
  ...
  @$pb.TagNumber(10)
  FragmentVideo get fragmentVideo => $_getN(9);
  @$pb.TagNumber(10)
  set fragmentVideo(FragmentVideo value) => $_setField(10, value);
  @$pb.TagNumber(10)
  $core.bool hasFragmentVideo() => $_has(9);
  @$pb.TagNumber(10)
  void clearFragmentVideo() => $_clearField(10);
  @$pb.TagNumber(10)
  FragmentVideo ensureFragmentVideo() => $_ensure(9);
}
...
class ConfValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConfValue', createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..a<$core.int>(1, _omitFieldNames ? '' : 'switchVal', $pb.PbFieldType.O3)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'selectedVal', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.int get switchVal => $_getIZ(0);
  @$pb.TagNumber(1)
  set switchVal($core.int value) => $_setSignedInt32(0, value);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  $core.int get selectedVal => $_getIZ(1);
  @$pb.TagNumber(2)
  set selectedVal($core.int value) => $_setSignedInt32(1, value);
  @$pb.TagNumber(2)
...
class DashItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DashItem', createEmptyInstance: create)
    ...
    ..a<$core.int>(5, _omitFieldNames ? '' : 'codecid', $pb.PbFieldType.OU3)
  ...
  @$pb.TagNumber(4)
  set bandwidth($core.int value) => $_setUnsignedInt32(3, value);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set codecid($core.int value) => $_setUnsignedInt32(4, value);
  @$pb.TagNumber(5)
...
class DashVideo extends $pb.GeneratedMessage {
  ...
  factory DashVideo.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory DashVideo.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DashVideo', createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'baseUrl')
    ..pPS(2, _omitFieldNames ? '' : 'backupUrl')
    ..a<$core.int>(3, _omitFieldNames ? '' : 'bandwidth', $pb.PbFieldType.OU3)
    ..a<$core.int>(4, _omitFieldNames ? '' : 'codecid', $pb.PbFieldType.OU3)
    ..aOS(5, _omitFieldNames ? '' : 'md5')
    ..a<$fixnum.Int64>(6, _omitFieldNames ? '' : 'size', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$core.int>(7, _omitFieldNames ? '' : 'audioId', $pb.PbFieldType.OU3)
  ...
  @$pb.TagNumber(4)
  set codecid($core.int value) => $_setUnsignedInt32(3, value);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(7)
  set audioId($core.int value) => $_setUnsignedInt32(6, value);
  @$pb.TagNumber(7)
...
class Dimension extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Dimension', createEmptyInstance: create)
    ...
    ..a<$core.int>(3, _omitFieldNames ? '' : 'rotate', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set rotate($core.int value) => $_setSignedInt32(2, value);
  @$pb.TagNumber(3)
...
class EpInlineVideo extends $pb.GeneratedMessage {
  ...
  factory EpInlineVideo.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory EpInlineVideo.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EpInlineVideo', createEmptyInstance: create)
...
class ExtraContent extends $pb.GeneratedMessage {
  factory ExtraContent({
    ...
    $fixnum.Int64? disableCode,
  }) {
    final result = create();
    if (disableReason != null) result.disableReason = disableReason;
    if (disableCode != null) result.disableCode = disableCode;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExtraContent', createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'disableReason')
    ..aInt64(2, _omitFieldNames ? '' : 'disableCode')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.String get disableReason => $_getSZ(0);
  @$pb.TagNumber(1)
  set disableReason($core.String value) => $_setString(0, value);
  @$pb.TagNumber(1)
  $core.bool hasDisableReason() => $_has(0);
  @$pb.TagNumber(1)
  void clearDisableReason() => $_clearField(1);

  @$pb.TagNumber(2)
  $fixnum.Int64 get disableCode => $_getI64(1);
  @$pb.TagNumber(2)
  set disableCode($fixnum.Int64 value) => $_setInt64(1, value);
  @$pb.TagNumber(2)
  $core.bool hasDisableCode() => $_has(1);
  @$pb.TagNumber(2)
  void clearDisableCode() => $_clearField(2);
}
...
class Fragment extends $pb.GeneratedMessage {
  ...
  factory Fragment.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Fragment.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Fragment', createEmptyInstance: create)
...
class FragmentInfo extends $pb.GeneratedMessage {
  ...
  factory FragmentInfo.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory FragmentInfo.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FragmentInfo', createEmptyInstance: create)
...
class FragmentVideo extends $pb.GeneratedMessage {
  ...
  factory FragmentVideo.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory FragmentVideo.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FragmentVideo', createEmptyInstance: create)
...
class FragmentVideoInfo extends $pb.GeneratedMessage {
  ...
  factory FragmentVideoInfo.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory FragmentVideoInfo.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FragmentVideoInfo', createEmptyInstance: create)
...
class PlayArc extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PlayArc', createEmptyInstance: create)
    ...
    ..a<$fixnum.Int64>(2, _omitFieldNames ? '' : 'aid', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(3, _omitFieldNames ? '' : 'cid', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
...
class PlayList extends $pb.GeneratedMessage {
  ...
  factory PlayList.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory PlayList.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PlayList', createEmptyInstance: create)
...
class ResponseDash extends $pb.GeneratedMessage {
  ...
  factory ResponseDash.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory ResponseDash.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResponseDash', createEmptyInstance: create)
...
class ResponseUrl extends $pb.GeneratedMessage {
  ...
  factory ResponseUrl.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory ResponseUrl.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResponseUrl', createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'order', $pb.PbFieldType.OU3)
    ..a<$fixnum.Int64>(2, _omitFieldNames ? '' : 'length', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
  ...
  @$pb.TagNumber(1)
  set order($core.int value) => $_setUnsignedInt32(0, value);
  @$pb.TagNumber(1)
...
class StreamInfo extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  set errCode($core.int value) => $_setUnsignedInt32(3, value);
  @$pb.TagNumber(4)
...
class VideoVod extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VideoVod', createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'aid', $pb.PbFieldType.O3)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'cid', $pb.PbFieldType.O3)
    ..a<$fixnum.Int64>(3, _omitFieldNames ? '' : 'qn', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$core.int>(4, _omitFieldNames ? '' : 'fnver', $pb.PbFieldType.O3)
    ..a<$core.int>(5, _omitFieldNames ? '' : 'fnval', $pb.PbFieldType.O3)
    ..a<$core.int>(6, _omitFieldNames ? '' : 'download', $pb.PbFieldType.OU3)
    ...
    ..a<$fixnum.Int64>(10, _omitFieldNames ? '' : 'voiceBalance', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set aid($core.int value) => $_setSignedInt32(0, value);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set cid($core.int value) => $_setSignedInt32(1, value);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(6)
  set download($core.int value) => $_setUnsignedInt32(5, value);
  @$pb.TagNumber(6)
...
class VodInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VodInfo', createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'quality', $pb.PbFieldType.OU3)
    ..aOS(2, _omitFieldNames ? '' : 'format')
    ..a<$fixnum.Int64>(3, _omitFieldNames ? '' : 'timelength', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$core.int>(4, _omitFieldNames ? '' : 'videoCodecid', $pb.PbFieldType.OU3)
  ...
  @$pb.TagNumber(4)
  set videoCodecid($core.int value) => $_setUnsignedInt32(3, value);
  @$pb.TagNumber(4)
