...
class AvatarItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AvatarItem', createEmptyInstance: create)
...
class BasicLayerResource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BasicLayerResource', createEmptyInstance: create)
    ..oo(0, [2, 3, 4])
...
class GeneralConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GeneralConfig', createEmptyInstance: create)
    ..m<$core.String, $core.String>(1, _omitFieldNames ? '' : 'webCssStyle', entryClassName: 'GeneralConfig.WebCssStyleEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS)
    ..hasRequiredFields = false
  ;
...
class Layer extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Layer', createEmptyInstance: create)
...
class LayerConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LayerConfig', createEmptyInstance: create)
    ..m<$core.String, LayerTagConfig>(1, _omitFieldNames ? '' : 'tags', entryClassName: 'LayerConfig.TagsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: LayerTagConfig.create, valueDefaultOrMaker: LayerTagConfig.getDefault)
...
class LayerGroup extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LayerGroup', createEmptyInstance: create)
...
class LayerTagConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LayerTagConfig', createEmptyInstance: create)
    ..oo(0, [2, 3, 4, 5])
...
class ResAnimation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResAnimation', createEmptyInstance: create)
...
class ResImage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResImage', createEmptyInstance: create)
...
class ResNativeDraw extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResNativeDraw', createEmptyInstance: create)
