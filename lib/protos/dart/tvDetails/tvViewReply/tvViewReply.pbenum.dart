...
class BizType extends $pb.ProtobufEnum {
  ...
  static final $core.List<BizType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 5);
...
class JumpShowType extends $pb.ProtobufEnum {
  ...
  static final $core.List<JumpShowType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static JumpShowType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class MaterialBizType extends $pb.ProtobufEnum {
  ...
  static final $core.List<MaterialBizType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 8);
  static MaterialBizType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class MaterialSource extends $pb.ProtobufEnum {
  ...
  static final $core.List<MaterialSource?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 1);
  static MaterialSource? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class PageCategory extends $pb.ProtobufEnum {
  ...
  static final $core.List<PageCategory?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 1);
  static PageCategory? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class PageType extends $pb.ProtobufEnum {
  ...
  static final $core.List<PageType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 1);
  static PageType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class PlayToastEnum extends $pb.ProtobufEnum {
  ...
  static final $core.List<PlayToastEnum?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 1);
  static PlayToastEnum? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class TabType extends $pb.ProtobufEnum {
  ...
  static final $core.List<TabType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 3);
  static TabType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class UnionType extends $pb.ProtobufEnum {
  ...
  static final $core.List<UnionType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static UnionType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
