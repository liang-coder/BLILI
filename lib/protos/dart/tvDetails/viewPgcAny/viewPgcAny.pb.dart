...
//
// Generated from lib/protos/proto/viewPgcAny.proto.
...
class Earphone extends $pb.GeneratedMessage {
  ...
  factory Earphone.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Earphone.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Earphone', createEmptyInstance: create)
...
class EarphoneConf extends $pb.GeneratedMessage {
  ...
  factory EarphoneConf.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory EarphoneConf.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EarphoneConf', createEmptyInstance: create)
...
class MultiViewInfo extends $pb.GeneratedMessage {
  ...
  factory MultiViewInfo.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory MultiViewInfo.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MultiViewInfo', createEmptyInstance: create)
...
class OgvData extends $pb.GeneratedMessage {
  factory OgvData({
    ...
    if (activityFloatLayer != null) result.activityFloatLayer.addAll(activityFloatLayer);
    ...
    if (horizontalCover169 != null) result.horizontalCover169 = horizontalCover169;
    if (horizontalCover1610 != null) result.horizontalCover1610 = horizontalCover1610;
  ...
  factory OgvData.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory OgvData.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OgvData', createEmptyInstance: create)
...
class OgvSwitch extends $pb.GeneratedMessage {
  factory OgvSwitch({
    ...
    final result = create();
    if (reduceShortTitleSpacing != null) result.reduceShortTitleSpacing = reduceShortTitleSpacing;
    if (mergePositionSectionForCinema != null) result.mergePositionSectionForCinema = mergePositionSectionForCinema;
    if (mergePreviewSection != null) result.mergePreviewSection = mergePreviewSection;
  ...
  factory OgvSwitch.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory OgvSwitch.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OgvSwitch', createEmptyInstance: create)
  ...
  @$pb.TagNumber(2)
  set mergePositionSectionForCinema($core.int value) => $_setSignedInt32(1, value);
  @$pb.TagNumber(2)
...
class PlayFloatLayerActivity extends $pb.GeneratedMessage {
  ...
  factory PlayFloatLayerActivity.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory PlayFloatLayerActivity.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PlayFloatLayerActivity', createEmptyInstance: create)
...
class PlayStrategy extends $pb.GeneratedMessage {
  factory PlayStrategy({
    ...
    if (recommendShowStrategy != null) result.recommendShowStrategy = recommendShowStrategy;
  ...
  factory PlayStrategy.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory PlayStrategy.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PlayStrategy', createEmptyInstance: create)
...
class Publish extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Publish', createEmptyInstance: create)
...
class UserStatus extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserStatus', createEmptyInstance: create)
...
class ViewPgcAny extends $pb.GeneratedMessage {
  ...
  factory ViewPgcAny.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory ViewPgcAny.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ViewPgcAny', createEmptyInstance: create)
    ..aOM<OgvData>(1, _omitFieldNames ? '' : 'ogvData', subBuilder: OgvData.create)
    ..m<$fixnum.Int64, $0.Staff>(2, _omitFieldNames ? '' : 'allUpInfo', entryClassName: 'ViewPgcAny.AllUpInfoEntry', keyFieldType: $pb.PbFieldType.O6, valueFieldType: $pb.PbFieldType.OM, valueCreator: $0.Staff.create, valueDefaultOrMaker: $0.Staff.getDefault)
    ..hasRequiredFields = false
  ;
...
class WatchProgress extends $pb.GeneratedMessage {
  ...
  factory WatchProgress.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory WatchProgress.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WatchProgress', createEmptyInstance: create)
