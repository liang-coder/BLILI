...
const EarphoneConf$json = {
  '1': 'EarphoneConf',
  '2': [
    {'1': 'sp_phones', '3': 1, '4': 3, '5': 11, '6': '.Earphone', '10': 'spPhones'},
  ],
};
...
final $typed_data.Uint8List earphoneConfDescriptor = $convert.base64Decode(
    'CgxFYXJwaG9uZUNvbmYSJgoJc3BfcGhvbmVzGAEgAygLMgkuRWFycGhvbmVSCHNwUGhvbmVz');
...
const OgvData$json = {
  ...
  '2': [
    ...
    {'1': 'rights', '3': 5, '4': 1, '5': 11, '6': '.Rights', '10': 'rights'},
    {'1': 'user_status', '3': 6, '4': 1, '5': 11, '6': '.UserStatus', '10': 'userStatus'},
    {'1': 'aid', '3': 7, '4': 1, '5': 3, '10': 'aid'},
    {'1': 'stat', '3': 8, '4': 1, '5': 11, '6': '.Stat', '10': 'stat'},
    {'1': 'mode', '3': 9, '4': 1, '5': 5, '10': 'mode'},
    {'1': 'publish', '3': 10, '4': 1, '5': 11, '6': '.Publish', '10': 'publish'},
    {'1': 'play_strategy', '3': 11, '4': 1, '5': 11, '6': '.PlayStrategy', '10': 'playStrategy'},
    {'1': 'multi_view_info', '3': 12, '4': 1, '5': 11, '6': '.MultiViewInfo', '10': 'multiViewInfo'},
    {'1': 'ogv_switch', '3': 13, '4': 1, '5': 11, '6': '.OgvSwitch', '10': 'ogvSwitch'},
    {'1': 'total_ep', '3': 14, '4': 1, '5': 5, '10': 'totalEp'},
    {'1': 'new_ep', '3': 15, '4': 1, '5': 11, '6': '.common.NewEp', '10': 'newEp'},
    {'1': 'reserve', '3': 16, '4': 1, '5': 11, '6': '.Reserve', '10': 'reserve'},
    {'1': 'status', '3': 17, '4': 1, '5': 5, '10': 'status'},
    {'1': 'activity_float_layer', '3': 18, '4': 3, '5': 11, '6': '.PlayFloatLayerActivity', '10': 'activityFloatLayer'},
    {'1': 'earphone_conf', '3': 19, '4': 1, '5': 11, '6': '.EarphoneConf', '10': 'earphoneConf'},
...
final $typed_data.Uint8List ogvDataDescriptor = $convert.base64Decode(
    ...
    'b25fdHlwZRgEIAEoBVIOc2hvd1NlYXNvblR5cGUSHwoGcmlnaHRzGAUgASgLMgcuUmlnaHRzUg'
    'ZyaWdodHMSLAoLdXNlcl9zdGF0dXMYBiABKAsyCy5Vc2VyU3RhdHVzUgp1c2VyU3RhdHVzEhAK'
    'A2FpZBgHIAEoA1IDYWlkEhkKBHN0YXQYCCABKAsyBS5TdGF0UgRzdGF0EhIKBG1vZGUYCSABKA'
    'VSBG1vZGUSIgoHcHVibGlzaBgKIAEoCzIILlB1Ymxpc2hSB3B1Ymxpc2gSMgoNcGxheV9zdHJh'
    'dGVneRgLIAEoCzINLlBsYXlTdHJhdGVneVIMcGxheVN0cmF0ZWd5EjYKD211bHRpX3ZpZXdfaW'
    '5mbxgMIAEoCzIOLk11bHRpVmlld0luZm9SDW11bHRpVmlld0luZm8SKQoKb2d2X3N3aXRjaBgN'
    'IAEoCzIKLk9ndlN3aXRjaFIJb2d2U3dpdGNoEhkKCHRvdGFsX2VwGA4gASgFUgd0b3RhbEVwEi'
    'QKBm5ld19lcBgPIAEoCzINLmNvbW1vbi5OZXdFcFIFbmV3RXASIgoHcmVzZXJ2ZRgQIAEoCzII'
    'LlJlc2VydmVSB3Jlc2VydmUSFgoGc3RhdHVzGBEgASgFUgZzdGF0dXMSSQoUYWN0aXZpdHlfZm'
    'xvYXRfbGF5ZXIYEiADKAsyFy5QbGF5RmxvYXRMYXllckFjdGl2aXR5UhJhY3Rpdml0eUZsb2F0'
    'TGF5ZXISMgoNZWFycGhvbmVfY29uZhgTIAEoCzINLkVhcnBob25lQ29uZlIMZWFycGhvbmVDb2'
    '5mEhQKBWNvdmVyGBQgASgJUgVjb3ZlchIhCgxzcXVhcmVfY292ZXIYFSABKAlSC3NxdWFyZUNv'
    'dmVyEhsKCXNoYXJlX3VybBgWIAEoCVIIc2hhcmVVcmwSHQoKc2hvcnRfbGluaxgXIAEoCVIJc2'
    'hvcnRMaW5rEhQKBXRpdGxlGBggASgJUgV0aXRsZRIvChNob3Jpem9udGFsX2NvdmVyMTY5GBkg'
    'ASgJUhJob3Jpem9udGFsQ292ZXIxNjkSMQoUaG9yaXpvbnRhbF9jb3ZlcjE2MTAYGiABKAlSE2'
    'hvcml6b250YWxDb3ZlcjE2MTASJQoPaGFzX2Nhbl9wbGF5X2VwGBsgASgFUgxoYXNDYW5QbGF5'
    'RXA=');
...
final $typed_data.Uint8List ogvSwitchDescriptor = $convert.base64Decode(
    ...
    'BCABKAVSEGVuYWJsZVNob3dWdEluZm8=');
...
const PlayFloatLayerActivity$json = {
  ...
  '2': [
    ...
    {'1': 'badge', '3': 8, '4': 1, '5': 11, '6': '.common.BadgeInfo', '10': 'badge'},
...
final $typed_data.Uint8List playFloatLayerActivityDescriptor = $convert.base64Decode(
    ...
    '1waWNfYW5pbWFfdXJsGAcgASgJUgtwaWNBbmltYVVybBInCgViYWRnZRgIIAEoCzIRLmNvbW1v'
    'bi5CYWRnZUluZm9SBWJhZGdlEiQKDnNob3dfcmF0ZV90aW1lGAkgASgDUgxzaG93UmF0ZVRpbW'
    'U=');
...
const Reserve$json = {
  '1': 'Reserve',
  '2': [
    {'1': 'episodes', '3': 1, '4': 3, '5': 11, '6': '.common.ViewEpisode', '10': 'episodes'},
...
final $typed_data.Uint8List reserveDescriptor = $convert.base64Decode(
    'CgdSZXNlcnZlEi8KCGVwaXNvZGVzGAEgAygLMhMuY29tbW9uLlZpZXdFcGlzb2RlUghlcGlzb2'
    'RlcxIQCgN0aXAYAiABKAlSA3RpcA==');
...
const Stat$json = {
  ...
  '2': [
    ...
    {'1': 'play_data', '3': 2, '4': 1, '5': 11, '6': '.common.StatInfo', '10': 'playData'},
  ],
};
...
final $typed_data.Uint8List statDescriptor = $convert.base64Decode(
    'CgRTdGF0EhwKCWZvbGxvd2VycxgBIAEoCVIJZm9sbG93ZXJzEi0KCXBsYXlfZGF0YRgCIAEoCz'
    'IQLmNvbW1vbi5TdGF0SW5mb1IIcGxheURhdGE=');
...
const UserStatus$json = {
  ...
  '2': [
    ...
    {'1': 'watch_progress', '3': 8, '4': 1, '5': 11, '6': '.WatchProgress', '10': 'watchProgress'},
  ],
};
...
final $typed_data.Uint8List userStatusDescriptor = $convert.base64Decode(
    ...
    'plbhgHIAEoBVIJdmlwRnJvemVuEjUKDndhdGNoX3Byb2dyZXNzGAggASgLMg4uV2F0Y2hQcm9n'
    'cmVzc1INd2F0Y2hQcm9ncmVzcw==');

@$core.Deprecated('Use viewPgcAnyDescriptor instead')
const ViewPgcAny$json = {
  '1': 'ViewPgcAny',
  '2': [
    {'1': 'ogv_data', '3': 1, '4': 1, '5': 11, '6': '.OgvData', '10': 'ogvData'},
    {'1': 'all_up_info', '3': 2, '4': 3, '5': 11, '6': '.ViewPgcAny.AllUpInfoEntry', '10': 'allUpInfo'},
  ],
...
const ViewPgcAny_AllUpInfoEntry$json = {
  ...
  '2': [
    ...
    {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.common.Staff', '10': 'value'},
  ],
  '7': {'7': true},
};
...
final $typed_data.Uint8List viewPgcAnyDescriptor = $convert.base64Decode(
    'CgpWaWV3UGdjQW55EiMKCG9ndl9kYXRhGAEgASgLMgguT2d2RGF0YVIHb2d2RGF0YRI6CgthbG'
    'xfdXBfaW5mbxgCIAMoCzIaLlZpZXdQZ2NBbnkuQWxsVXBJbmZvRW50cnlSCWFsbFVwSW5mbxpL'
    'Cg5BbGxVcEluZm9FbnRyeRIQCgNrZXkYASABKANSA2tleRIjCgV2YWx1ZRgCIAEoCzINLmNvbW'
    '1vbi5TdGFmZlIFdmFsdWU6AjgB');
