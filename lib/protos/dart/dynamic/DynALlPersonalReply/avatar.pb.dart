...
class AvatarItem extends $pb.GeneratedMessage {
  ...
  factory AvatarItem.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory AvatarItem.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AvatarItem', package: const $pb.PackageName(_omitMessageNames ? '' : 'avatar'), createEmptyInstance: create)
...
class BasicLayerResource extends $pb.GeneratedMessage {
  ...
  factory BasicLayerResource.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory BasicLayerResource.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BasicLayerResource', package: const $pb.PackageName(_omitMessageNames ? '' : 'avatar'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4])
  ...
  @$pb.TagNumber(1)
  set resType($core.int value) => $_setSignedInt32(0, value);
  @$pb.TagNumber(1)
...
class GeneralConfig extends $pb.GeneratedMessage {
  ...
  factory GeneralConfig.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory GeneralConfig.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GeneralConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'avatar'), createEmptyInstance: create)
    ..m<$core.String, $core.String>(1, _omitFieldNames ? '' : 'webCssStyle', entryClassName: 'GeneralConfig.WebCssStyleEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('avatar'))
    ..hasRequiredFields = false
  ;
...
class Layer extends $pb.GeneratedMessage {
  ...
  factory Layer.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory Layer.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Layer', package: const $pb.PackageName(_omitMessageNames ? '' : 'avatar'), createEmptyInstance: create)
...
class LayerConfig extends $pb.GeneratedMessage {
  ...
  factory LayerConfig.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory LayerConfig.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LayerConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'avatar'), createEmptyInstance: create)
    ..m<$core.String, LayerTagConfig>(1, _omitFieldNames ? '' : 'tags', entryClassName: 'LayerConfig.TagsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: LayerTagConfig.create, valueDefaultOrMaker: LayerTagConfig.getDefault, packageName: const $pb.PackageName('avatar'))
...
class LayerGroup extends $pb.GeneratedMessage {
  ...
  factory LayerGroup.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory LayerGroup.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LayerGroup', package: const $pb.PackageName(_omitMessageNames ? '' : 'avatar'), createEmptyInstance: create)
...
class LayerTagConfig extends $pb.GeneratedMessage {
  factory LayerTagConfig({
    ...
    if (commentDoubleClickConfig != null) result.commentDoubleClickConfig = commentDoubleClickConfig;
  ...
  factory LayerTagConfig.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory LayerTagConfig.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LayerTagConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'avatar'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4, 5])
  ...
  @$pb.TagNumber(1)
  set configType($core.int value) => $_setSignedInt32(0, value);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(4)
  set commentDoubleClickConfig($1.CommentDoubleClickConfig value) => $_setField(4, value);
  @$pb.TagNumber(4)
...
class ResAnimation extends $pb.GeneratedMessage {
  ...
  factory ResAnimation.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory ResAnimation.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResAnimation', package: const $pb.PackageName(_omitMessageNames ? '' : 'avatar'), createEmptyInstance: create)
...
class ResImage extends $pb.GeneratedMessage {
  ...
  factory ResImage.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory ResImage.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResImage', package: const $pb.PackageName(_omitMessageNames ? '' : 'avatar'), createEmptyInstance: create)
...
class ResNativeDraw extends $pb.GeneratedMessage {
  ...
  factory ResNativeDraw.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory ResNativeDraw.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResNativeDraw', package: const $pb.PackageName(_omitMessageNames ? '' : 'avatar'), createEmptyInstance: create)
